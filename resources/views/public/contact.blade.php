...
<main>
    ...
    <div class="aside__form__container">
        ...
        <aside class="aside">
            ...
            <p class="aside__text">Devenez la personne qui, chaque jour, offrent de leur temps et de leur énergie pour
                prendre soin de nos animaux. Grâce à leur engagement, chaque animal reçoit l’attention et l’amour qu’il
                mérite.</p>
            <svg class="aside__decor" xmlns="http://www.w3.org/2000/svg" width="201" height="226" viewBox="0 0 201 226"
                 fill="none">
