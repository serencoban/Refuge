...
<main>
    ...
    <aside class="aside">
        <h2 class="aside__title">Devenir bénévole, poser une question,...</h2>
        ...
        <svg class="aside__decor" xmlns="http://www.w3.org/2000/svg" width="201" height="226" viewBox="0 0 201 226" fill="none">
            <circle cx="33.1323" cy="188.138" r="80" transform="rotate(75 33.1323 188.138)" fill="#414833"/>
            <ellipse cx="40.5555" cy="65.149" rx="23" ry="30" transform="rotate(11.5979 40.5555 65.149)" fill="#414833"/>
            <ellipse cx="116.359" cy="94.897" rx="23" ry="30" transform="rotate(30 116.359 94.897)" fill="#414833"/>
            <ellipse cx="150.916" cy="173.636" rx="23" ry="30" transform="rotate(61.0843 150.916 173.636)" fill="#414833"/>
        </svg>
    </aside>
    <section class="contact-form">
        <form class="contact-form__form" action="#" method="post">
            ...
            <div class="contact-form__group">
                ...
                <input class="contact-form__input" type="text" name="firstname" id="firstname" placeholder="ex: Jane">
            </div>
            ...
            <div class="contact-form__group">
                ...
                <input class="contact-form__input" type="email" name="email" id="email" placeholder="ex: janedoe@gmail.com">
            </div>

            <div class="contact-form__group">
                <label class="contact-form__label" for="message">Votre message*</label>
                <textarea class="contact-form__input" id="message" name="message" rows="5" placeholder="ex: Je voudrais rejoindre votre équipe pour ..."></textarea>
            </div>
